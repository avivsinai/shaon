...
Deep reverse-engineering of an example Hilanet instance at `https://{subdomain}.hilan.co.il`.
...
```
Parse `"OrgId":"(\d+)"` from HTML/JS. ExampleCorp OrgId embedded in page source.
